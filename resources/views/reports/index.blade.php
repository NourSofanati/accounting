                ...
                <div class="p-5">
                    <div class="flex flex-wrap gap-2 justify-around  ">
                        ...
                        <a class=" relative p-1 border-gray-100 cursor-pointer "
                            href="{{ route('logbook.create') }}">
                            <div
                                class="h-3 w-3 bg-gray-400 rounded-full absolute mx-auto left-0 right-0 bottom-4 top-0">
                            </div>
                            <div class="bg-gray-400 rounded w-8 absolute right-0 left-0 top-1 mx-auto block h-2">
                            </div>
                            <div
                                class="block border-8 border-gray-100 h-52 w-36 shadow hover:shadow-md transition-shadow duration-150 ">
                                <div
                                    class="w-full h-full bg-white grid place-items-center border border-gray-200 hover:border-gray-300">
                                    <span class="w-10 h-10">
                                        @include('icons.reports.MonthlyReport')
                                    </span>
                        ...
                        <a class=" relative p-1 border-gray-100 cursor-pointer "
                            href="{{ route('monthly-report.create') }}">
                            <div
                                class="h-3 w-3 bg-gray-400 rounded-full absolute mx-auto left-0 right-0 bottom-4 top-0">
                            </div>
                            <div class="bg-gray-400 rounded w-8 absolute right-0 left-0 top-1 mx-auto block h-2">
